package org.example.pizzatoppings;
...
public class PizzaToppings extends Application {
    ...
    public void start (Stage primaryStage)
    {
        ...
        onionsCheckBox = new CheckBox("Onions $1.00");
        mushroomsCheckBox = new CheckBox("Mushrooms $1.00");
        anchoviesCheckBox = new CheckBox("Anchovies $1.00");
        peppersCheckBox = new CheckBox("Peppers $1.00");

        // Create the Button control.
        Button totalButton = new Button("Get Total");

        // Register the even handler.
        ...
        VBox checkBoxVBox = new VBox (10, pepperoniCheckBox, cheeseCheckBox,
                onionsCheckBox, mushroomsCheckBox, anchoviesCheckBox, peppersCheckBox);
        ...
        BasicOptionPaneUI.ButtonAreaLayout mainVbox;
