...
public class LinkedListDriver {
    public static void main(String[] args) {
        ...
        LinkedList<GeometricShape> shapes = new LinkedList<>();
            ...
            switch (choice) {
                ...
                case 4:
                    if (shapes.size() < 2){
                        ...
                        if (index1 < shapes.size() && index2 < shapes.size()) {
                            System.out.println(shapes.get(index1).equals(shapes.get(index2))
                ...
                case 7:
                    ...
                    if (cloneIdx >= 0 && cloneIdx < shapes.size()) {
                        try {
                            GeometricShape cloned = shapes.get(cloneIdx).clone();
                            shapes.add(cloned);
                ...
                case 8:
                    ...
                    if (dateIdx >= 0 && dateIdx < shapes.size()) {
                        shapes.get(dateIdx).setCreationDate(new Date());
