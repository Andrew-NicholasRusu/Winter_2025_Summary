...
public class Triangle extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        Line line2 = new Line(BOTTOM_RIGHT_X, BOTTOM_RIGHT_Y, BOTTOM_LEFT_X, BOTTOM_LEFT_Y);

        // Draw the third line, from the bottom-left corner
        // of the triangle to the bottom-right corner.
        Line line3 = new Line(BOTTOM_LEFT_X, BOTTOM_LEFT_Y, TOP_X, TOP_Y);

        // Add the lines to a pane.
        Pane pan = new Pane(line1, line2, line3);

        // Create a Scene and display it.
        Scene scene = new Scene(pan, SCENE_WIDTH, SCENE_HEIGHT);
